...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-md-10" >
            <h2>Films</h2>
            <asp:GridView DataKeyNames="Id" CssClass="table table-stripped table-hover" ID="GridViewFilms" DataSourceID="FilmsDataSource" AllowCustomPaging ="true" AutoGenerateColumns ="false" PersistedSelection="true" PagerSettings-Mode="Numeric" runat="server" AllowPaging ="true" PageSize="2" >
                <Columns>
